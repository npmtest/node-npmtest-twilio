...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-twilio/node_modules/twilio/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-twilio/node_modules/twilio/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-twilio/node_modules/twilio/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function initializer(sid, tkn, options) {</span>
<span class="cstat-no" title="statement not covered" >    return new RestClient(sid, tkn, options);</span>
}
&nbsp;
